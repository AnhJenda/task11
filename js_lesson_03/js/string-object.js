...
// Find the length of the string and puts this in the msg variable
...
// Find the index number of the last instance of 'e' in the string and add it to the msg variable
msg += '<h2>last e</h2><p>' + saying.lastIndexOf(e) + '</p>';
// Find the character with an index in the 8-14 range in the string and add it to the msg variable
msg += '<h2>character index: 8-14</h2><p>' + saying.substring(8,14) + '</p>';
// Find the first instance of 'me' in the string and replace it with a charecter 'w' and add it to msg variable
